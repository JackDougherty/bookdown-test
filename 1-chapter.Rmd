...
```{r otl-town-borders, echo=FALSE, fig.cap="(ref:otl-town-borders)", fig_height=9}
...
<!-- includes custom-script.html for iframe height -->
```{r 1910-otl-home-value, echo=FALSE, fig.cap="(ref:1910-otl-home-value)", fig_height=9}
...
3. Is `auto.pdf=TRUE` necessary? How about `out.width="100%"`?
