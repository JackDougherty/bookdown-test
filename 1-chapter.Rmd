...
```{r otl-town-borders, echo=FALSE, fig.cap="(ref:otl-town-borders)", fig_height=9, auto.pdf=TRUE, screenshot.alt="images/1600s-otl-town-borders.jpg"}
...
Test non-scrolling map (quick sample with same caption to test HTML height)
```{r otl-home-value, echo=FALSE, fig_height=10, fig.cap="(ref:otl-town-borders)", auto.pdf=TRUE, screenshot.alt="images/1600s-otl-town-borders.jpg"}
if(knitr::is_html_output()) knitr::include_url("https://ontheline.github.io/otl-home-value/") else knitr::include_graphics("images/1600s-otl-town-borders.jpg")
```
